...
// just use this simplified version which covers the cases we used:
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Manual variant handling for simplicity/vibecoding speed
    const baseStyles =
      "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50";

    const variants = {
      default:
        "bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-blue-200/50",
      destructive:
